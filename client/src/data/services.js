...
bloqueos y restaurar la armonía energética.
    `,
    includes: [
...
comprender procesos y tomar decisiones con mayor conciencia.
    `,
    includes: [
      'Lectura personalizada',
...
no en predicciones cerradas, acompañando el proceso personal.
    `,
    includes: ['Lectura personalizada', 'Análisis del momento actual', 'Orientación práctica'],
    duration: '45 a 60 minutos',
    modality: 'Online',
  },
];
